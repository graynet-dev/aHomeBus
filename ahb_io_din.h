...
#define AHB_IO_DIN__H

    #include <Arduino.h>
    #include <inttypes.h>
    #include <ahb.h>

    #define AHB_IO_DIN_DIRECT  0 //pushed = on, released = off - e.g. switch, temporary action, etc
    #define AHB_IO_DIN_BTOGGLE 1 //toggle every time button is pushed - e.g. push-button as light swtich, etc
    #define AHB_IO_DIN_STOGGLE 2 //toggle every time button is pushed or released - e.g. multiple switches for switching lights
     ...
     * @see AHB_IO
     */
    class AHB_IO_DIN : public AHB_IO {
        private:
            /**
        ...
        public:
             ...
             * @param ahbIoDIn configuration struct reference
             * @return bool true if successful
             */
            bool cfgWrite(ahbIoDIn &cfg);
