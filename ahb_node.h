...
// настраиваем отладку-------------------------------------------------------------------------------// 
                                                                                                     //
#define debug1                   //отладка в сериал_монитор. Закоментировать строку, если не нужна    //
#ifdef debug                                                                                         //
...
const char stringMES_0[10] PROGMEM = "NULL_C"; 
const char stringMES_1[10] PROGMEM = "КОМАНДА";                 //= "COMMAND";    
const char stringMES_2[10] PROGMEM = "ОТЧЁТ О КОМАНДЕ";         //= "COMMAND_REPORT";  
const char stringMES_3[10] PROGMEM = "ЗАПРОС ПАРАМЕТРА";        //= "PARAMETER_REQUEST";  
const char stringMES_4[10] PROGMEM = "ПАРАМЕТР";                //= "PARAMETER"; 
const char stringMES_5[10] PROGMEM = "ЗАПРОС СТАТУСА";          //= "STATUS_REQUEST";    
const char stringMES_6[10] PROGMEM = "СТАТУС";                  //= "STATUS";   
const char stringMES_7[10] PROGMEM = "ЗАПРОС МУЛЬТИКАДРА";      //= "MULTIFRAME_REQUEST";
const char stringMES_8[10] PROGMEM = "МУЛЬТИКАДР";              //= "MULTIFRAME";   
const char stringMES_9[10] PROGMEM = "КОНЕЦ МУЛЬТИКАДРА";       //= "MULTIFRAME_END";
const char stringMES_10[10] PROGMEM = "АВАРИЯ";                 //= "ACCIDENT";  
const char stringMES_11[10] PROGMEM = "АВАРИЯ ПРИНЯТА";         //= "ACCIDENT_REPORT";
...
const char stringADDR_0[10]  PROGMEM = "ШИРОКОВЕЩАТЕЛЬНО           ";
const char stringADDR_1[10]  PROGMEM = "node_1_Net_center_PC       ";
const char stringADDR_2[10]  PROGMEM = "node_2_Net_center_oraPi1   ";  
const char stringADDR_3[10]  PROGMEM = "node_3_Net_center_oraPi2   "; 
const char stringADDR_4[10]  PROGMEM = "node_4_Net_center_Due1     ";
const char stringADDR_5[10]  PROGMEM = "node_5_Net_center_Due2     ";    
const char stringADDR_6[10]  PROGMEM = "node_6_Hallway_net_center  ";
const char stringADDR_7[10]  PROGMEM = "node_7_Hallway_main        ";  
const char stringADDR_8[10]  PROGMEM = "node_8_Hallway_light       ";
const char stringADDR_9[10]  PROGMEM = "node_9_Kitchen_net_center  ";
const char stringADDR_10[10] PROGMEM = "node_10_Kitchen_main       ";
const char stringADDR_11[10] PROGMEM = "node_11_Kitchen_light      ";
const char stringADDR_12[10] PROGMEM = "node_12_WC_main            ";
const char stringADDR_13[10] PROGMEM = "node_13_WC_waterleak       ";         
const char stringADDR_14[10] PROGMEM = "node_14_Bathroom_main      ";  
const char stringADDR_15[10] PROGMEM = "node_15_Boxroom_main       ";
const char stringADDR_16[10] PROGMEM = "node_16_Balcony_meteo      ";
const char stringADDR_17[10] PROGMEM = "node_17_Loggia_main        ";
const char stringADDR_18[10] PROGMEM = "node_18_Loggia_recuperator ";              
const char stringADDR_19[10] PROGMEM = "node_19_Livingroom_main    ";               
const char stringADDR_20[10] PROGMEM = "node_20_Bedroom_main       ";                 
const char stringADDR_21[10] PROGMEM = "node_21_Cabinet_main       ";               
...
const char stringPAR_0[10] PROGMEM = "NULL PARAMETER"; //0 
const char stringPAR_1[10] PROGMEM = "ДАТЧИК ТЕМПЕРАТУРЫ ВОЗДУХА"; //1 air_temperature_censor
const char stringPAR_2[10] PROGMEM = "ДАТЧИК ВЛАЖНОСТИ ВОЗДУХА"; //2 air_humidity_censor
const char stringPAR_3[10] PROGMEM = "ДАТЧИК ДАВЛЕНИЯ ВОДУХА"; //3 air_pressure_censor
const char stringPAR_4[10] PROGMEM = "ДАТЧИК ДВИЖЕНИЯ ПИРОЭЛЕКТРИЧЕСКИЙ (ИК)"; //4 motion_pir_censor
const char stringPAR_5[10] PROGMEM = "ДАТЧИК ДВИЖЕНИЯ МИКРОВОЛНОВОЙ"; //5  motion_mw_censor
const char stringPAR_6[10] PROGMEM = "ДАТЧИК ВИБРАЦИИ"; //6 vibration_censor
const char stringPAR_7[10] PROGMEM = "ДАТЧИК ШУМА"; //7  noise_censor
const char stringPAR_8[10] PROGMEM = "ДАТЧИК ОСВЕЩЁННОСТИ"; // Illumination_censor
const char stringPAR_9[10] PROGMEM = "ДАТЧИК ГАЗА CO"; //9  gas_co_censor
const char stringPAR_10[10] PROGMEM = "ДАТЧИК ГАЗА CO2"; //10 gas_co2_censor
const char stringPAR_11[10] PROGMEM = "ДАТЧИК МЕТАНА"; //11 gas_metan_censor 
const char stringPAR_12[10] PROGMEM = "ДАТЧИК КУРЕНИЯ"; //12  smoke_censor
const char stringPAR_13[10] PROGMEM = "ДАТЧИК ОГНЯ"; //13  fire_censor
const char stringPAR_14[10] PROGMEM = "ДАТЧИК ТЕМПЕРАТУРЫ ТЕЛА"; //14  body_temperature_censor
const char stringPAR_15[10] PROGMEM = "ДАТЧИК ОТРКРЫТИЯ ЖАЛЮЗИ"; //15  jalousie_status_censor 
const char stringPAR_16[10] PROGMEM = "ДАТЧИК ПАРА"; //16 steam_censor
const char stringPAR_17[10] PROGMEM = "ДАТЧИК ИЗЛУЧЕНИЯ МИКРОВОЛНОВОЙ"; //17 microwave_censor
const char stringPAR_18[10] PROGMEM = "ДАТЧИК ТЕМПЕРАТУРЫ ХОЛОДИЛЬНИКА"; //18 fridge_temperature_censor
const char stringPAR_19[10] PROGMEM = "ДАТЧИК ТЕМПЕРАТУРЫ МОРОЗИЛКА"; // 19 freezer_temperature_censor
const char stringPAR_20[10] PROGMEM = "ДАТЧИК ТЕМПЕРАТУРЫ ДУХОВКА"; // 20 oven_temperature_censor
const char stringPAR_21[10] PROGMEM = "ДАТЧИК ЗАКРЫТИЯ ЭЛЕКТРОЩИТА"; // 21 electrical_board_censor
const char stringPAR_22[10] PROGMEM = "ДАТЧИК ЗАКРЫТИЯ ЗАМКА ДВЕРИ"; // 22 door_lock_censor
const char stringPAR_23[10] PROGMEM = "ДАТЧИК ЗАКРЫТИЯ ДВЕРИ"; // 23 door_close_censor
const char stringPAR_24[10] PROGMEM = "ДАТЧИК ПРОХОДА 1"; // 24 motion_door1_censor
const char stringPAR_25[10] PROGMEM = "ДАТЧИК ПРОХОДА 2"; //25 motion_door2_censor
const char stringPAR_26[10] PROGMEM = "ДАТЧИК ЗАКРЫТИЯ ОКНА"; // 26 window_close_censor
const char stringPAR_27[10] PROGMEM = "ДАТЧИК ТЕМПЕРАТУРЫ ГОРЯЧЕЙ ВОДЫ"; // 27 water_hot_temperature_censor 
const char stringPAR_28[10] PROGMEM = "ДАТЧИК ТЕМПЕРАТУРЫ ХОЛОДНОЙ ВОДЫ"; // 28 water_cold_temperature_censor
const char stringPAR_29[10] PROGMEM = "ДАТЧИК ДАВЛЕНИЯ ГОРЯЧЕЙ ВОДЫ"; // 29 water_hot_pressure_censor
const char stringPAR_30[10] PROGMEM = "ДАТЧИК ДАВЛЕНИЯ ХОЛОДНОЙ ВОДЫ"; // 3 0water_cold_pressure_censor
const char stringPAR_31[10] PROGMEM = "ДАТЧИК ПРОТЕЧКИ"; // 31 leakage_censor
const char stringPAR_32[10] PROGMEM = "ДАТЧИК ВКЛЮЧЕНИЯ ЛАМПЫ АКВАРИУМА"; //46 lamp_aquarium_censor
const char stringPAR_33[10] PROGMEM = "ДАТЧИК ТЕМПЕРАТУРЫ АКВАРИУМА"; //47 aquarium_temperature_censor
const char stringPAR_34[10] PROGMEM = "ДАТЧИК ВКЛЮЧЕНИЯ НАСОСА АКВАРИУМА"; //48 aquarium_pump_censor
const char stringPAR_35[10] PROGMEM = "ДАТЧИК ВКЛЮЧЕНИЯ ФИЛЬТРА ОЧИСТКИ АКВАРИУМА"; //49 aquarium_clearing_censor
const char stringPAR_36[10] PROGMEM = "ДАТЧИК ЗАКРЫТИЯ ДВЕРИ ШКАФА";  //36 cupboard_door_censor
const char stringPAR_37[10] PROGMEM = "ДАТЧИК ЗАКРЫТИЯ ДВЕРИ СЕЙФА"; //37 safe_door_censor
const char stringPAR_38[10] PROGMEM = "ДАТЧИК ЗАКРЫТИЯ ДВЕРИ БАЛКОНА"; //38 balcony_door_censor
const char stringPAR_39[10] PROGMEM = "ДАТЧИК ЗАКРЫТИЯ ДВЕРИ ЛОДЖИИ"; // 39 loggia_door_censor
const char stringPAR_40[10] PROGMEM = "ДАТЧИК ТЕМПЕРАТУРЫ БАТАРЕИ"; //40 radiator_temperature_censor
const char stringPAR_41[10] PROGMEM = "ДАТЧИК ВКЛЮЧЕНИЯ ЛАМПЫ НА ПОТОЛКЕ"; //41 lamp_ceiling_censor
const char stringPAR_42[10] PROGMEM = "ДАТЧИК ВКЛЮЧЕНИЯ НАСТЕННОЙ ЛАМПЫ"; //42 lamp_wall_censor
const char stringPAR_43[10] PROGMEM = "ДАТЧИК ВКЛЮЧЕНИЯ ЛАМПЫ ПОДСВЕТКИ"; //43 lamp_Illumination_censor
const char stringPAR_44[10] PROGMEM = "ДАТЧИК ВКЛЮЧЕНИЯ АВАРИЙНАЯ ЛАМПЫ"; //44 lamp_accident_censor
const char stringPAR_45[10] PROGMEM = "ДАТЧИК ВЛАЖНОСТИ ЗЕМЛИ"; //45 earth_humidity_censor
const char stringPAR_46[10] PROGMEM = "СЧЕТЧИК ГАЗА"; //32 counter_gas_censor
const char stringPAR_47[10] PROGMEM = "";                    //47 сервис байт
const char stringPAR_48[10] PROGMEM = "СЧЕТЧИК ГОРЯЧЕЙ ВОДЫ"; // 33 counter_water_hot_censor
const char stringPAR_49[10] PROGMEM = "";                     //49 сервис байт
const char stringPAR_50[10] PROGMEM = "СЧЕТЧИК ХОЛОДНОЙ ВОДЫ"; // 34 counter_water_hot_censor
const char stringPAR_51[10] PROGMEM = "";                    //51 сервис байт
const char stringPAR_52[10] PROGMEM = "СЧЕТЧИК ЭЛЕКТРОЭНЕРГИИ"; // 35 counter_electricity_censor
const char stringPAR_53[10] PROGMEM = "";                    //53 сервис байт
const char stringPAR_54[10] PROGMEM = "";                    //54 сервис байт
const char stringPAR_55[10] PROGMEM = "";                    //55 сервис байт

const char stringPAR_56[10] PROGMEM = "НАПРЯЖЕНИЕ АКБ ИБП"; // 35 counter_electricity_censor
const char stringPAR_57[10] PROGMEM = "";                    //57 сервис байт
const char stringPAR_58[10] PROGMEM = "";                    //58 сервис байт
const char stringPAR_59[10] PROGMEM = "";                    //59 сервис байт
...
const char stringDEV_0[10] PROGMEM = "NULL DEVICE";
const char stringDEV_1[10] PROGMEM = "ЛАМПА НА ПОТОЛКЕ БУЛЕВАЯ"; //64 lamp_ceiling_onoff_device
const char stringDEV_2[10] PROGMEM = "ЛАМПА НАСТЕННАЯ БУЛЕВАЯ"; //65 lamp_wall_onoff_device
const char stringDEV_3[10] PROGMEM = "ЛАМПА ПОДСВЕТКИ БУЛЕВАЯ"; //66 lamp_Illumination_onoff_PARice
const char stringDEV_4[10] PROGMEM = "ЛАМПА АВАРИЙНАЯ БУЛЕВАЯ"; //67 lamp_accident_onoff_device
const char stringDEV_5[10] PROGMEM = "ЛАМПА НА ПОТОЛКЕ ДИММЕР"; //68 lamp_ceiling_dimm_device
const char stringDEV_6[10] PROGMEM = "ЛАМПА НА СТЕНЕ ДИММЕР"; //69 lamp_wall_dimm_device 
const char stringDEV_7[10] PROGMEM = "ЛАМПА ПОДСВЕТКИ ДИММЕР"; //70 lamp_Illumination_dimm_device
const char stringDEV_8[10] PROGMEM = "ЛАМПА АВАРИЙНАЯ ДИММЕР"; //71 lamp_accident_dimm_device
const char stringDEV_9[10] PROGMEM = "ВЕНТИЛЯТОР"; // 72 fan 
const char stringDEV_10[10] PROGMEM = "РЕКУПЕРАТОР";//73 recuperator
const char stringDEV_11[10] PROGMEM = "КОНДИЦИОНЕР"; // 74 air_conditioning 
const char stringDEV_12[10] PROGMEM = "КЛАПАН РАДИАТОРА ОТОПЛЕНИЯ"; // 75 valve_radiator
const char stringDEV_13[10] PROGMEM = "ЖАЛЮЗИ"        ; // 76 jalousie
const char stringDEV_14[10] PROGMEM = "КРАН ГАЗА"      ; // 77 valve_gas 
const char stringDEV_15[10] PROGMEM = "КРАН ГОРЯЧЕЙ ВОДЫ"  ; // 78 valve_hot_water
const char stringDEV_16[10] PROGMEM = "КРАН ХОЛОДНОЙ ВОДЫ"   ; //79 valve_cold_water
const char stringDEV_17[10] PROGMEM = "ИК ПРИЕМОПЕРЕДАТЧИК IRDA"               ; // 80 irda
const char stringDEV_18[10] PROGMEM = "ОСВЕЖИТЕЛЬ ВОЗДУХА"            ; // 81 freshener
const char stringDEV_19[10] PROGMEM = "УВЛАЖНИТЕЛЬ ВОЗДУХА"           ; // 82 humidifier 
const char stringDEV_20[10] PROGMEM = "ЗАМОК ДВЕРИ МАГНИТНЫЙ"      ; // 83 door_lock_magnet
const char stringDEV_21[10] PROGMEM = "ЗАМОК ДВЕРИ ЭЛЕКТРОМАГНИТНЫЙ"     ; //84 door_lock_electromagnet 
const char stringDEV_22[10] PROGMEM = "ЗАМОК ДВЕРИ ЭЛЕКТРОМЕХАНИЧЕСКИЙ"     ;  //85 door_lock_electromechanical
const char stringDEV_23[10] PROGMEM = "ЗАМОК ДВЕРИ BLINK"        ; // 86  door_lock_blink 
const char stringDEV_24[10] PROGMEM = "СИРЕНА"                  ; // 87 siren
const char stringDEV_25[10] PROGMEM = "СТРОБОСКОП МИГАЛКА";  // 88 blinker 
const char stringDEV_26[10] PROGMEM = "МУЗЫКА";  // 89 music
const char stringDEV_27[10] PROGMEM = "ТВ"; // 90 tv
const char stringDEV_28[10] PROGMEM = "РАДИО"; // 91 radio 
const char stringDEV_29[10] PROGMEM = "РОЗЕТКА";  // 92 power_socket 
...
const char stringCOM_0[10]  PROGMEM = "БУЛЕВОЕ ВЫКЛ";
const char stringCOM_1[10]  PROGMEM = "БУЛЕВОЕ ВКЛ";
const char stringCOM_2[10]  PROGMEM = "БУЛЕВОЕ ИНВЕРТИРОВАТЬ";  
const char stringCOM_3[10]  PROGMEM = "ЗНАЧЕНИЕ ДИММЕРА УСТАНОВИТЬ"; 
const char stringCOM_4[10]  PROGMEM = "ЗНАЧЕНИЕ ДИММЕРА УМЕНЬШИТЬ";
const char stringCOM_5[10]  PROGMEM = "ЗНАЧЕНИЕ ДИММЕРА УВЕЛИЧИТЬ";    
const char stringCOM_6[10]  PROGMEM = "ИМПУЛЬСНОЕ ВКЛ";
const char stringCOM_7[10]  PROGMEM = "ИМПУЛЬСНОЕ ВЫКЛ"; 
const char stringCOM_8[10]  PROGMEM = "ИМПУЛЬСНОЕ ИНВЕРТИРОВАТЬ"; 
const char stringCOM_9[10]  PROGMEM = "ЗНАЧЕНИЕ PWM УСТАНОВИТЬ"; 
const char stringCOM_10[10]  PROGMEM = "ЗНАЧЕНИЕ PWM УМЕНЬШИТЬ";
const char stringCOM_11[10]  PROGMEM = "ЗНАЧЕНИЕ PWM УВЕЛИЧИТЬ"; 
const char stringCOM_12[10]  PROGMEM = "УСТАНОВИТЬ ЗНАЧЕНИЕ ПАРАМЕТРА"; 
